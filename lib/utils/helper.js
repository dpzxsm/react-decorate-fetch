...
function buildFetch(url) {
  ...
  params = Object.assign({}, defaults.fetchOptions.params, params); // merge special options

  finalOptions.headers = Object.assign({}, defaults.fetchOptions.headers, finalOptions.headers); // merge options
