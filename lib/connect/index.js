...
function _default(_mapRequestToProps) {
  _mapRequestToProps = _mapRequestToProps || function () {
    return {};
  };
  if ((0, _isPlainObject2.default)(_mapRequestToProps)) {
    _mapRequestToProps = function mapRequestToProps() {
      return _mapRequestToProps;
    };
  }
  return function (WrappedComponent) {
    var ConnectComponent = function (_Component) {
      ...
      function ConnectComponent(props, context) {
        ...
        _this.state = _this.refactorMapRequestToState(_mapRequestToProps((0, _helper.omitChildren)(props)));
        return _this;
      }
      ...
      _createClass(ConnectComponent, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
          if (!(0, _shallowEqual2.default)(nextProps, this.props)) {
            ...
            var newState = this.refactorMapRequestToState(_mapRequestToProps((0, _helper.omitChildren)(nextProps)));
            this.setState({
