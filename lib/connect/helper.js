...
function buildFetch(url) {
  ...
  var _filterOptions = filterOptions(options),
      _filterOptions$params = _filterOptions.params,
      params = _filterOptions$params === undefined ? {} : _filterOptions$params,
      otherOptions = _objectWithoutProperties(_filterOptions, ['params']);
